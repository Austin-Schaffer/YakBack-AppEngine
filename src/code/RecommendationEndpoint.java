...
import com.example.yakback.EMF;
...
@Api(name = "recommendationendpoint", namespace = @ApiNamespace(ownerDomain = "google.com",
...
public class RecommendationEndpoint {
  ...
  public Recommendation removeRecommendation(@Named("id") Long id) {
    EntityManager mgr = getEntityManager();
    Recommendation recommendation = null;
    try {
      recommendation = mgr.find(Recommendation.class, id);
